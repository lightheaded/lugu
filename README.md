...
**Pre-alpha.** The walking skeleton (M0) works: sign in, browse your libraries, play
books and podcast episodes, keep your position. Everything else in
...
- Browse and search a library, open an item, see podcast episodes
- Streaming playback via Media3/ExoPlayer with a `MediaLibraryService`: notification
  controls, exact seeking, multi-file books handled as one timeline
